function Filter({ filterData, courses, setCategory, category }) {
    ...
    return (
    <div className="w-11/12 flex flex-wrap max-w-max space-x-4 gap-y-4 mx-auto py-4 justify-center font-bold">
        {
                filterData.map((data) => { 
                return(
